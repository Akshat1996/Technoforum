  ...
  text-transform: uppercase;
	...
	<div id="fh5co-page" style="background: rgba(0, 0, 0, 0.6);height:auto;
     ...
     <% try{
        ...
        hs.setAttribute("setmode",mode);
        String dg=hs.getAttribute("designation").toString();
        batch=hs.getAttribute("batch").toString();
      ...
      query1="select email from productdetail where batch='"+batch+"'";
       ...
       if(count==0){
     %>
 		  <div style="height:400px;width:1000px;"> <h1 style="text-align:center;color:white;margin:40px;">No Items to Confirm  !!!</h1></div>
    <%
       }
