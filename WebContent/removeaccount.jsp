...
<div class="login-page">
  <div class="form">
      <a href="updatedetail.jsp"><button id="login_button"  >Remove Student</button></a><br><br>
      <a href="removeadminaccount.jsp?mode=admin"><button id="login_button"  >Remove Admin</button></a><br><br>
      <a href="removeadminaccount.jsp?mode=member"><button id="login_button"  >Remove Club Member</button></a><br><br>
