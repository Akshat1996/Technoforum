...
<div class="login-page">
  <div class="form">
      <a href="addadmininfo.jsp"><button id="login_button"  >Add as Admin</button></a><br><br>
	<a href="addmemberinfo.jsp"><button id="login_button"  >Add as Member</button></a><br><br>
