...
<div class="login-page">
  <div class="form">
      <a href="loginstudent.jsp"><button id="login_button"  >login as Student</button></a><br><br>
      <a href="loginadmin.jsp"><button id="login_button"  >login as Admin</button></a><br><br>
      <a href="loginclubmember.jsp"><button id="login_button"  >login as Club Member</button></a><br><br>
