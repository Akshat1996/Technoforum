...
<div class="fh5co-pricing-style-2" style="background:rgba(0, 0, 0, 0.0);margin-top:10px;">
  ...
  query="select * from productdetail where email='"+e+"' and batch='"+b+"' and accepted='no' and status='complete'";
  Dao d=new Dao();
  ...
  <%}
  if(count==0){%>
	  <div style="height:400px;width:1000px;"> <h1 style="text-align:center;color:white;margin:40px;">No Pending Items For you !!!</h1></div>
  <%}}catch(Exception e){
	  e.printStackTrace();
  }%>  
  </div>
