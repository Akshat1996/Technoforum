  ...
  text-transform: uppercase;
	...
	<div id="fh5co-page" style="background: rgba(0, 0, 0, 0.6);height:auto;
     ...
     <% 
        ...
        String query1="select * from mp where email='"+email+"'";
        Dao d=new Dao();
			...
			<div class="container">
				...
				<div class="row">
						...
						<a href="#" class="link-block">
							...
							<h3>Remove Penalty</h3>
							<p style="text-align:center;margin-top:20px;"><a href="addpenalty.jsp?error=removepenalty" class="btn btn-primary btn-sm">Explore It</a></p>
						</a>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".8s">
						<a href="#" class="link-block">
							...
							<h3>Add Penalty</h3>
							<p style="text-align:center;margin-top:20px;"><a href="addpenalty.jsp?error=addpenalty" class="btn btn-primary btn-sm">Explore It</a></p>
						</a>
					</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.1s">
						<a href="#" class="link-block">
							...
							<p style="text-align:center;margin-top:20px;"><a href="confirmrequest.jsp?mode=confirm" class="btn btn-primary btn-sm">Explore It</a></p>
						</a>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.4s">
						<a href="#" class="link-block">
							...
							<p style="text-align:center;margin-top:20px;"><a href="confirmrequest.jsp?mode=accept" class="btn btn-primary btn-sm">Explore It</a></p>
						</a>
					</div>
				</div>
			</div>
